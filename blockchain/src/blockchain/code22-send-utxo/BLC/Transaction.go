...
// 生成普通转账交易
func NewSimpleTransaction(from  string,to string,amount int,blockchain *BlockChian) *Transaction {
	// 输入
	...
	// 查找可用的UTXO
	money,spendableUTXODic := FindSpendableUTXO(from,int64(amount),blockchain)
